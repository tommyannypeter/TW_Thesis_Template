...
Furthermore, to recognize whether the MET is from real undetectable particles or from the mismeasurement of objects, two kinds of the MET significance $S$ are applied. One is the event-based MET significance which is performed in previous monoHbb analysis, and the other is the object-based MET significance which is newly introduced in the analysis. They will be depicted more detailed in the following section.
